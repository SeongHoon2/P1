...
<body>
	<div class="homeFrame">
		...
		<div class="homeFrame_div5">
			<div class="homeFrame_div5_left">
			...
			<span>
			이메일 : gdmania1@naver.com
			</span><br><br>
			<span>
			Copyright ©2023- P1 Coating Korea. All rights reserved.
			</span><br><br>
			</div>
			<div class="homeFrame_div5_right">
				<img alt="map" src="resources/img/map.png">
			</div>
		</div>
	</div>
</body>
