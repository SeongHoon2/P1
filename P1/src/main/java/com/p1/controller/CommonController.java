...
import com.p1.util.SMTPAuthenticatior;
...
public class CommonController {
	...
	@ResponseBody public String sendMailAjax(@RequestParam HashMap<String, Object> params) throws Throwable {
		...
		String from = "p1center@ellevtech.cafe24.com";
		String to = "gdmania1@naver.com";
		String subject =  "P1 Center KR 문의";
		String content = "";
		content += "이름 : ";
		content += params.get("param_name").toString();
		content += "<br><br>주제 : ";
		content += params.get("param_category").toString();
		content += "<br><br>국가 : ";
		content += params.get("param_nation").toString();
		content += "<br><br>이메일 : ";
